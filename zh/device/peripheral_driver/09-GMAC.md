...
| :---: | :---: | :---: | :---: | :---: |
| TX速率 (MB/s) | 942 | 658 | 942 | 599 |
| RX速率 (MB/s) | 941 | 661 | 941 | 652 |
注：双工情形下测试带宽具有一定波动    
...
两块k1-deb1板子eth0、eth1口均用网线直连、直连的两个网口IP地址设置在同一个网段，例如：  
```
#机器A eth0
ifconfig eth0 192.168.0.100 netmask 255.255.255.0

#机器B eth0
ifconfig eth1 192.168.0.200 netmask 255.255.255.0
...
```
为达到最佳网络性能，将两块板子两个网卡中断分别绑定到不同cpu核，首先查找eth0、eth1中断信息  
```
# cat /proc/interrupts | grep eth*
 77:         33          0          0          0          0          0          0          0  SiFive PLIC 131 Edge      eth0
 78:         35          0          0          0          0          0          0          0  SiFive PLIC 133 Edge      eth1
```
eth0、eth1中断分别绑定到cpu3、cpu4
```
 # echo 08 > /proc/irq/77/smp_affinity
...
```
#机器A
iperf3 -s -A 1 -D -B 192.168.0.100
iperf3 -s -A 2 -D -B 192.168.1.100
#机器B
iperf3 -c 192.168.0.100 -A 1 -t 30 -B 192.168.0.200 > 1.txt &
iperf3 -c 192.168.1.100 -A 2 -t 30 -B 192.168.1.200 > 2.txt &
```
...
iperf3 -s -A 2 -D -B 192.168.1.100
#机器B
iperf3 -c 192.168.0.100 -A 1 -t 30 -B 192.168.0.200 -R > 1.txt &
iperf3 -c 192.168.1.100 -A 2 -t 30 -B 192.168.1.200 -R > 2.txt &
```
...
iperf3 -s -A 2 -D -B 192.168.1.100
#机器B
iperf3 -c 192.168.0.100 -A 1 -t 30 -B 192.168.0.200 --bidir > 1.txt &
iperf3 -c 192.168.1.100 -A 2 -t 30 -B 192.168.1.200 --bidir > 2.txt &
```
