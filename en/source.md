...
- For Bianbu Linux 2.2.7 and later
...
For Bianbu Linux 2.2.7 and later, containerized builds are supported by default, so you only need to [install Docker CE](https://docs.docker.com/engine/install/)
...
Note: Starting with Bianbu Linux 2.2.7
